...
namespace Lexiphone.Controllers
{
    public class OrderRowsController : Controller
    {
        ...
        {
            var orderRows = db.OrderRows.Include(o => o.Orders).Include(o => o.Products);
        ...
        public ActionResult Create([Bind(Include = "Id,OrderId,Quantity,PurchasePrise,ProductId")] OrderRow orderRow)
        {
            ...
            ViewBag.ProductId = new SelectList(db.Products, "Id", "Name", orderRow.ProductId);
            return View(orderRow);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,OrderId,Quantity,PurchasePrise,ProductId")] OrderRow orderRow)
        {
            if (ModelState.IsValid)
            {
